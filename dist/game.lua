local ____GameConfig = ((function() local x, y = pcall(require, 'game_src\game\config\GameConfig'); return x and y end)()) or _G.____GameConfig
local ____GameManager = ((function() local x, y = pcall(require, 'game_src\game\managers\GameManager'); return x and y end)()) or _G.____GameManager
local ____gameUI = ((function() local x, y = pcall(require, 'game_src\ui\gameUI'); return x and y end)()) or _G.____gameUI
local function main_2929()
