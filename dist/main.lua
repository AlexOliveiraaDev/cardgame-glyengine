local std = ((function() local x, y = pcall(require, 'source_shared_var_object_std'); return x and y end)()) or _G.std
local application_default = ((function() local x, y = pcall(require, 'source_shared_var_object_root'); return x and y end)()) or _G.application_default
local callback_http = ((function() local x, y = pcall(require, 'source_engine_protocol_http_callback'); return x and y end)()) or _G.callback_http
local engine_math = ((function() local x, y = pcall(require, 'source_engine_api_system_math'); return x and y end)()) or _G.engine_math
local engine_key = ((function() local x, y = pcall(require, 'source_engine_api_system_key'); return x and y end)()) or _G.engine_key
local engine_game = ((function() local x, y = pcall(require, 'source_engine_api_system_app'); return x and y end)()) or _G.engine_game
local engine_color = ((function() local x, y = pcall(require, 'source_engine_api_system_color'); return x and y end)()) or _G.engine_color
local engine_raw_node = ((function() local x, y = pcall(require, 'source_engine_api_raw_node'); return x and y end)()) or _G.engine_raw_node
local engine_raw_memory = ((function() local x, y = pcall(require, 'source_engine_api_raw_memory'); return x and y end)()) or _G.engine_raw_memory
local engine_raw_bus = ((function() local x, y = pcall(require, 'source_engine_api_raw_bus'); return x and y end)()) or _G.engine_raw_bus
local engine_storage = ((function() local x, y = pcall(require, 'source_engine_api_io_storage'); return x and y end)()) or _G.engine_storage
local engine_media = ((function() local x, y = pcall(require, 'source_engine_api_io_media'); return x and y end)()) or _G.engine_media
local engine_http = ((function() local x, y = pcall(require, 'source_engine_api_io_http'); return x and y end)()) or _G.engine_http
local engine_log = ((function() local x, y = pcall(require, 'source_engine_api_debug_log'); return x and y end)()) or _G.engine_log
local engine_i18n = ((function() local x, y = pcall(require, 'source_engine_api_data_i18n'); return x and y end)()) or _G.engine_i18n
local engine_hash = ((function() local x, y = pcall(require, 'source_engine_api_data_hash'); return x and y end)()) or _G.engine_hash
local engine_encoder = ((function() local x, y = pcall(require, 'source_engine_api_data_encoder'); return x and y end)()) or _G.engine_encoder
local engine_array = ((function() local x, y = pcall(require, 'source_engine_api_data_array'); return x and y end)()) or _G.engine_array
local engine_draw_ui = ((function() local x, y = pcall(require, 'source_engine_api_draw_ui'); return x and y end)()) or _G.engine_draw_ui
local engine_draw_text = ((function() local x, y = pcall(require, 'source_engine_api_draw_text'); return x and y end)()) or _G.engine_draw_text
local engine_draw_poly = ((function() local x, y = pcall(require, 'source_engine_api_draw_poly'); return x and y end)()) or _G.engine_draw_poly
local engine_draw_fps = ((function() local x, y = pcall(require, 'source_engine_api_draw_fps'); return x and y end)()) or _G.engine_draw_fps
local loadgame = ((function() local x, y = pcall(require, 'source_shared_engine_loadgame'); return x and y end)()) or _G.loadgame
local loadcore = ((function() local x, y = pcall(require, 'source_shared_engine_loadcore'); return x and y end)()) or _G.loadcore
local util_decorator = ((function() local x, y = pcall(require, 'source_shared_functional_decorator'); return x and y end)()) or _G.util_decorator
local version = ((function() local x, y = pcall(require, 'source_version'); return x and y end)()) or _G.version
local function main_1fd648()
